...
public class Stage5 {
	 ...
	 * @param target
	 * @param endIndex
	 * @return true if target exists anywhere up to index endIndex (inclusive) in
	 ...
	 *         For example, if data = {10,20,10,30,10,20,30,10,10,30,30}, return {5,
	 *         2, 4} as there are three distinct items (10, 20, 30) and, the first
	 *         "first-of-its-kind" item (10) occurs 5 times the second
	 *         "first-of-its-kind" item (20) occurs 2 times the third
	 *         "first-of-its-kind" item (30) occurs 4 times
	 * 
