...
public class Stage4 {
	 ...
	 * @return an arraylist containing all items in data that also exist in unique,
	 * in the order they exist in unique.
	 * That is, 
	 * all occurrences of unique.get(0), followed by,
	 * all occurrences of unique.get(1), followed by,
	 * all occurrences of unique.get(2), followed by,
	 * ...
	 * for example, if
	 ...
	 */
	public static ArrayList<Integer> getAllItemsFrom(ArrayList<Integer> data, ArrayList<Integer> unique) {
