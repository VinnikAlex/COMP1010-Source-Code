...
public class Stage2 {
	 ...
	 * 
	 * @param list
	 * @return the sum of all items of the list return 0 if list is null or empty
	 */
	 ...
	 * 
	 * @param list
	 * @return the sum of all negatives items of the list return 0 if list is null
	 *         or empty
	 */
	 ...
	 * 
	 * @param list
	 * @return the number of even items in the list return 0 if list is null or
	 *         empty
	 */
	 ...
	 * @param list
	 * @param target
	 * @return the number of times target exists in the list return 0 if list is
	 *         null or empty
	 */
	 ...
	 * @return the number of items in the list that belong to the range [low ...
	 *         high] return 0 if list is null or empty
	 */
	 ...
	 *         [low ... high] return false if list is null or empty
	 */
	 ...
	 *         return false if list is null return true if the list is empty
	 */
...
//		}
	 ...
	 * 
	 * @param list
	 * @return the number of prime numbers in the list return 0 if list is null or
	 *         empty
	 * 
	 *         IMPORTANT: you can (and should) use the helper method isPrime(int)
	 *         from class MathService as MathService.isPrime(value_to_check)
	 */
	 ...
	 * 
	 * @param list
	 * @return true if there is at least one prime number in the list, false
	 *         otherwise return false if list is null or empty
	 * 
	 *         IMPORTANT: you can (and should) use the helper method isPrime(int)
	 *         from class MathService as MathService.isPrime(value_to_check)
	 */
	 ...
	 *         return false if list is null return true if the list is empty
	 *         (because technically, every item in the list IS prime)
	 * 
	 *         IMPORTANT: you can (and should) use the helper method isPrime(int)
	 *         from class MathService as MathService.isPrime(value_to_check)
	 */
	 ...
	 * 
	 * @param list
	 * @return number of rectangles in the list that are squares (you can, and
	 *         should invoke, the instance method isSquare() in class Rectangle)
	 ...
	 * 
	 * @param list
	 * @return the sum of all even items of the list passed. return 0 if the list is
	 *         null
	 */
	 ...
	 * 
	 * @param list
	 * @return the sum of all odd items of the list passed. return 0 if the list is
	 *         null
	 */
...
//		return count;
	 ...
	 * @param low
	 * @param high
	 * @return sum of all items of the list passed that lie OUTSIDE the number range
	 *         [low...high]
	 */
	...
	/**
	 * 
	 * @param list reset any negative value(s) in the list passed to zero.
	 */
	...
	/**
	 * 
	 * @param list update any negative value(s) in the list passed to positive
	 *             value. for example, if list[2] is -5, it should become 5.
	 */
	 ...
	 * 
	 * @param list
	 * @return the number of odd numbers in the list passed. return 0 if the list is
	 *         null.
	 */
	 ...
	 * @param low
	 * @param high
	 * @return number of items in the list passed that are OUTSIDE the number range
	 *         [low...high]. return 0 if the list is null.
	 */
	 ...
	 * @param list
	 * @param target
	 * @return number of times target exists in the list passed. return 0 if list is
	 *         null.
	 */
	 ...
	 * 
	 * @param list
	 * @return the number of items in the list passed that occur exactly once in the
	 *         list. return 0 if list is null. HINT: use method countOccurrences
	 */
	 ...
	 *         passed, false otherwise. return false if list is null or target
	 *         doesn't exist in the list starting at index startIndex.
	 */
	 ...
	 * @param target
	 * @param endIndex
	 * @return true if target exists up to (and including) index endIndex at which
	 *         target exists in the list passed, false otherwise. return false if
	 *         list is null or target doesn't exist in the list up to (and
	 *         including) index endIndex.
	 */
	 ...
	 *         which target exists in the list passed, false otherwise. return false
	 *         if list is null or target doesn't exist in the list in the index
	 ...
	 * @param list
	 * @param endIndex
	 * @return product of all positive items up to index endIndex. return 1 if list
	 ...
	 *         if list is null or if no negative items exist starting at index
	 *         startIndex.
	 */
	 ...
	 *         and endIndex. return 0 if list is null or if key doesn't exist
	 *         between indices startIndex and endIndex.
	 */
	 ...
	 * @param startIndex
	 * @param endIndex
	 * @return number of items that exist exactly once in the list between the
	 *         indices startIndex and endIndex. return 0 if list is null or none of
	 ...
	 *         otherwise. return false if the list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if all items of the list are negative (less than 0), false
	 *         otherwise. return false if the list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if all items of the list are zero, false otherwise. return false
	 *         if the list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if all items of the list are non-zero, false otherwise. return
	 *         false if the list is null.
	 */
	 ...
	 *         array, false otherwise. return false if the list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if the list is in ascending order, false otherwise. return false
	 *         if the list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if the list is in descending order, false otherwise. return
	 *         false if the list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if all items of the list are the same, false otherwise. return
	 *         false if the list is null.
	 */
	 ...
	 *         otherwise 1 if the list is sorted in ascending order, otherwise -1 if
	 *         list is sorted in descending order, otherwise 0 return 0 if list is
	 *         null.
	 * 
	 *         NOTE: an list like {5, 5, 5} is sorted in both ascending AND
	 *         descending order
	 */
	 ...
	 *         and negative (less than 0) items. return false if list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return true if each list.get(i) of the list is a valid digit ('0' to '9'),
	 *         false otherwise. return false if list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return the characters of the list converted to a String. return null if the
	 *         list is null.
	 */
	 ...
	 * 
	 * @param list
	 * @return a copy of the list. NOTE: the list returned SHOULD NOT refer to the
	 *         same collection that the list passed refers to. In other words if you
	 *         update the values in the list returned, the values in the list passed
	 *         should not change.
	 */
